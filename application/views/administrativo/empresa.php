                        ...
                        <div class="row">
                            ...
                            if (isset($informacion[0]->emp_logo))
                                if (!empty($informacion[0]->emp_logo)) {
                                    ?>
                                    <center><img  style="width: 350;height: 155px;border:2px solid #000;border-radius: 15px" src="<?php echo base_url('uploads') . '/empresa/' . $informacion[0]->emp_id . "/" . $informacion[0]->emp_logo; ?>"></center>
                                <?php } ?>
                        </div> 
                        <div class="row">
